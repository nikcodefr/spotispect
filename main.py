...
# Dashboard Section
if st.session_state.spotify_sp:
    st.header('Dashboard', divider="green")

    def user_dashboard(sp, artist):
        # Add the full implementation of the user_dashboard function here
    ...
    def global_dashboard(sp, artist):
        # Add the full implementation of the global_dashboard function here
    ...
    if artist_search:
        try:
            sp = st.session_state.spotify_sp
